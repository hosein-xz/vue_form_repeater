<template>
    <div class="" style="padding: 50px;">
            <div class="form-group xz_form  row animated slideInDown" v-for="count in counter" :id="count" style="min-width: 1500px;">
                <div data-repeater-list="" class="col-lg-12">
                    <div data-repeater-item=""
                         class="form-group row align-items-center">
                        <div class="col-xs-1 delete_btn"
                             style="margin-top:30px;border:2px solid lightgray;border-radius:14px;">
                            <div data-repeater-delete=""
                                 class="btn " style="margin-right: 6px;"
...
<!--                     onclick="todo('board')" style="margin-left: 20px;">-->
<!--                                <span>-->
<!--                                <i class="la la-plus"></i>-->
<!--                                <span>Copy</span>-->
<!--                                </span>-->
